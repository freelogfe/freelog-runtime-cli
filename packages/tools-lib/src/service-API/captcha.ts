...
interface SendVerificationCodeParamsType {
  loginName: string;
  authCodeType: 'register' | 'resetPassword' | 'activateTransactionAccount' | 'updateTransactionAccountPwd' | 'updateMobileOrEmail' | 'activateTransactionAccount' | 'verifyIdentity';
}
