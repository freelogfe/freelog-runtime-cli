...
const ENTRIES = [
  ...
  ['当前目录不是独立资源 manifest', 'cli.not_single_resource_manifest', 'Current directory is not a single-resource manifest'],
  ...
  ['部分目录项未能加入合集目录草稿', 'cli.partial_items_not_added_to_draft', 'Some items could not be added to collection catalogue draft'],
  ...
  ['合集目录项授权未完成', 'cli.collection_item_auth_incomplete', 'Collection item authorization incomplete'],
