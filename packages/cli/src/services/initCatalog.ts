import type { ScaffoldInitCategory } from './resourceTypePicker.js';
...
export const TEMPLATE_DISPLAY_NAMES: Record<string, string> = {
  ...
  'webpack-vue-ts': 'freelog主题-webpack-vue-ts',
  'webpack-vue': 'freelog主题-webpack-vue',
  'webpack-react-ts': 'freelog主题-webpack-react-ts',
  'webpack-react': 'freelog主题-webpack-react',
