...
本文定义 `packages/cli/src` 的代码分类与依赖方向。产品行为以仓库根目录 `DESIGN.md` 为准；**一期产品设计总纲**见 [docs/新方案/一期/01-产品设计总纲.md](../../../docs/新方案/一期/01-产品设计总纲.md)，流程拓扑见 [02-CLI体验拓扑设计.md](../../../docs/新方案/一期/02-CLI体验拓扑设计.md)；本文只约束实现结构。
