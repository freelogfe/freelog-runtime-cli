...
本文定义 `packages/cli/src` 的代码分类与依赖方向。产品行为以仓库根目录 `DESIGN.md` 为准；**一期产品主线方案**见 [docs/一期/产品方案/README.md](../../../docs/一期/产品方案/README.md)，实现解决方案见 [06-实现解决方案](../../../docs/一期/产品方案/06-实现解决方案.md)；本文只约束实现结构。
