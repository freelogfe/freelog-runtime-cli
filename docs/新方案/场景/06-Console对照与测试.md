...
> **核对结论与不一致清单：** [Console对齐核对报告](../对齐/Console对齐核对报告.md) · 分角色：[产品经理](../使用/产品经理简明手册.md) / [测试人员](../使用/测试人员简明手册.md) / [普通用户](../使用/普通用户简明手册.md)
...
| **自动化** | **小说 P2/P3/P4/连载** | S16–S16d · [08 NOV-*](./08-测试人员手册.md#63-小说p2p3p4) |
| **自动化** | **短视频 P2/P3/P4 批量/维护** | S10 / VID-03 / VID-05 / S12 |
| **自动化** | **bind 半路接入 / 冲突** | COM-06 / COM-07 |
| **自动化** | **跨账号 owner 负向** | E3（辅账号 `snnaenu`，不可 policy） |
...
1. `node test/run-all-scenarios.mjs --env dev` 的 mandatory 场景与必选 parity 域全部通过；失败为零，未批准 skip 为零。
