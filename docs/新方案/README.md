...
| 查看一次真实环境结果 | [2026-08-17 dev](./验证/reports/2026-08-17-dev.md) · [2026-08-14 dev](./验证/reports/2026-08-14-dev.md) · [2026-08-12 dev](./验证/reports/2026-08-12-dev.md) · [2026-08-13 prod 流程](./验证/reports/2026-08-13-prod.md) |
...
- 两个 dev 专用测试账号密码仅允许集中写在 `CLI交接文档.md` §3.2；token、cookie、authorization
  和任何 prod 密码不得进入仓库，其他文档不得复制密码。
...
- 官方示例默认使用 production；test/dev 仅说明为授权环境选项。当前暂停验收的 `package` 预设不进入公开使用文档。
