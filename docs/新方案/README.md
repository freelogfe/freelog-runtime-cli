...
| 开始手动测试 | [手动测试](./验证/手动测试.md) · [场景目录](./验证/场景目录.md) · [探索测试清单](./验证/探索测试清单.md)（含 P6 `verify:p6-parity`） |
| 查看一次真实环境结果 | [2026-08-12 dev](./验证/reports/2026-08-12-dev.md) · [2026-08-13 prod 流程](./验证/reports/2026-08-13-prod.md) |
