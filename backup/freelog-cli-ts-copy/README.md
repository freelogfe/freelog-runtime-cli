...
> 新方案（产品 + 开发设计）：[docs/新方案/README.md](./docs/新方案/README.md)  
> 使用：[docs/使用/使用指南.md](./docs/使用/使用指南.md)
...
- [docs/新方案/README.md](./docs/新方案/README.md) — 产品与开发设计（权威）
- [docs/使用/使用指南.md](./docs/使用/使用指南.md) — 当前可跑命令
